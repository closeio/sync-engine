...
localized_folder_names = {
    "trash": {
        ...
        "Papelera",
        "Borradores",
        "[Imap]/\xd0\x9a\xd0\xbe\xd1\x80" "\xd0\xb7\xd0\xb8\xd0\xbd\xd0\xb0",
        "Deleted Items",
        "\xd0\xa1\xd0\xbc\xd1\x96\xd1\x82\xd1\x82\xd1\x8f",
        "Papierkorb/Trash",
        "Gel\xc3\xb6schte Elemente",
        "Deleted Messages",
        "[Gmail]/Trash",
        "INBOX/Trash",
        "Trash",
        "mail/TRASH",
        "INBOX.Trash",
        "INBOX.\xc9l\xe9ments supprim\xe9s",
        "INBOX.INBOX.Trash",
    },
    "spam": {
        "Roskaposti",
    ...
    "sent": {
        ...
        "INBOX.SentMail",
        "Gesendet",
        "Ko\xc5\xa1/Sent Items",
        "Gesendete Elemente",
        "INBOX.\xc9l\xe9ments envoy\xe9s",
        "INBOX.INBOX.Sent",
        "Objets envoy\xe9s",
    },
}
