...
def upgrade():
    op.create_index('ix_actionlog_status_namespace_id_record_id', 'actionlog',
        ['status', 'namespace_id', 'record_id'], unique=False)
...
def downgrade():
    op.create_index('idx_actionlog_status_type', 'actionlog',
