...
def upgrade():
    ...
    op.drop_column("account", "o_access_token")
    op.drop_column("account", "o_audience")
    op.drop_column("account", "o_scope")
    op.drop_column("account", "o_token_type")
    op.drop_column("account", "o_id_token")
    op.drop_column("account", "o_access_type")
    op.drop_column("account", "o_expires_in")
    op.drop_column("account", "o_user_id")
    op.drop_column("account", "provider_prefix")
    op.drop_column("account", "o_verified_email")
    op.drop_column("account", "provider")
    op.drop_column("account", "date")
    op.drop_column("account", "o_token_issued_to")
    op.drop_column("account", "o_refresh_token")
