...
def patch_token_manager(monkeypatch):
    monkeypatch.setattr(
        "inbox.sendmail.smtp.postel.default_token_manager", MockTokenManager()
    )
    monkeypatch.setattr(
        "inbox.sendmail.smtp.postel.g_token_manager", MockGoogleTokenManager()
    )
...
def disallow_auth(monkeypatch):
    monkeypatch.setattr(
        "inbox.sendmail.smtp.postel.default_token_manager",
        MockTokenManager(allow_auth=False),
    )
    monkeypatch.setattr(
        "inbox.sendmail.smtp.postel.g_token_manager",
