...
def upgrade():
    ...
    conn.execute(
        text(
            "ALTER TABLE accounttransaction DROP FOREIGN KEY accounttransaction_ibfk_1"
        )
    )
    conn.execute(
        text(
            "ALTER TABLE accounttransaction ADD CONSTRAINT accounttransaction_ibfk_1 FOREIGN KEY "
