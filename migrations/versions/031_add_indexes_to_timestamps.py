...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_folderitem_deleted_at", "folderitem", ["deleted_at"], unique=False
    )
    op.create_index(
        "ix_folderitem_updated_at", "folderitem", ["updated_at"], unique=False
    )

    op.create_index(
        "ix_foldersync_created_at", "foldersync", ["created_at"], unique=False
    )
    op.create_index(
        "ix_foldersync_deleted_at", "foldersync", ["deleted_at"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "ix_messagecontactassociation_deleted_at",
        "messagecontactassociation",
        ["deleted_at"],
        unique=False,
    )
    op.create_index(
        "ix_messagecontactassociation_updated_at",
        "messagecontactassociation",
        ["updated_at"],
        unique=False,
    )
    op.create_index(
        "ix_namespace_created_at", "namespace", ["created_at"], unique=False
    )
    op.create_index(
        "ix_namespace_deleted_at", "namespace", ["deleted_at"], unique=False
    )
    op.create_index(
