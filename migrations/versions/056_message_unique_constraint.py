...
def upgrade():
    ...
    op.drop_constraint(
        "messagecontactassociation_ibfk_2",
        "messagecontactassociation",
        type_="foreignkey",
    )
    ...
    with session_scope(versioned=False) as db_session:
        groups = (
            ...
            .group_by(Message.thread_id, Message.g_msgid)
    ...
    op.execute(
        "ALTER TABLE message ADD UNIQUE INDEX ix_message_thread_id_g_msgid (thread_id, g_msgid)"
    )
