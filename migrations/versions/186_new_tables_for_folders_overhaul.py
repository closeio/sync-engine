...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_category_public_id", "category", ["public_id"], unique=False
    )
    op.create_index(
        "ix_category_created_at", "category", ["created_at"], unique=False
    )
    op.create_index(
        "ix_category_deleted_at", "category", ["deleted_at"], unique=False
    )
    op.create_index(
        "ix_category_updated_at", "category", ["updated_at"], unique=False
    )
    op.create_table(
        "label",
        sa.Column("created_at", sa.DateTime(), nullable=False),
    ...
    op.create_index(
        "ix_label_created_at", "label", ["created_at"], unique=False
    )
    op.create_index(
        "ix_label_deleted_at", "label", ["deleted_at"], unique=False
    )
    op.create_index(
        "ix_label_updated_at", "label", ["updated_at"], unique=False
    )
    op.create_table(
        "messagecategory",
        sa.Column("created_at", sa.DateTime(), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["imapuid_id"], ["imapuid.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["label_id"], ["label.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
    ...
    op.add_column(
        "folder", sa.Column("category_id", sa.Integer(), nullable=True)
    )
