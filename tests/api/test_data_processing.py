...
def test_contact_rankings(db, api_client, default_namespace):
    ...
    recipients = (
        [[("first", "number1@nylas.com")]] * 8
        + [[("second", "number2@nylas.com")]] * 4
        + [[("third", "number3@nylas.com")]]
        + [[("third", "number3@nylas.com"), ("fourth", "number4@nylas.com")]]
    )
    ...
    resp = api_client.get_raw("/contacts/rankings?force_recalculate=true")
...
def test_contact_groups(db, api_client, default_namespace):
    ...
    groups = [
        "a@nylas.com, b@nylas.com, c@nylas.com, d@nylas.com",
