...
def upgrade():
    ...
    op.create_index(
        "ix_contactsearchindexcursor_created_at",
        "contactsearchindexcursor",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        "ix_contactsearchindexcursor_deleted_at",
        "contactsearchindexcursor",
        ["deleted_at"],
        unique=False,
    )
    op.create_index(
        "ix_contactsearchindexcursor_transaction_id",
        "contactsearchindexcursor",
        ["transaction_id"],
        unique=False,
    )
    op.create_index(
        "ix_contactsearchindexcursor_updated_at",
        "contactsearchindexcursor",
        ["updated_at"],
        unique=False,
    )
