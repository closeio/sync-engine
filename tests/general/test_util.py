...
def test_matching_subdomains(monkeypatch):
    ...
    assert (
        matching_subdomains("test.servers.nylas.com.au", "mail.nylas.com.au")
        is True
    )
    assert (
        matching_subdomains("test.servers.nylas.com", "mail.nylas.com.au")
        is False
    )
...
def test_extract_emails_from_text():
    ...
    assert extract_emails_from_text('email="test@example.com"') == [
        "test@example.com"
    ]
