...
def upgrade():
    op.create_table(
        ...
        sa.Column(
            "name", sa.String(length=191, collation="utf8mb4_bin"), nullable=True
        ),
        sa.Column("display_name", sa.String(length=191), nullable=False),
        sa.Column("type_", sa.Enum("folder", "label"), nullable=False),
        sa.ForeignKeyConstraint(
            ["namespace_id"], ["namespace.id"], name="category_fk1", ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("namespace_id", "name", "display_name"),
        sa.UniqueConstraint("namespace_id", "public_id"),
    )
    op.create_index("ix_category_public_id", "category", ["public_id"], unique=False)
    op.create_index("ix_category_created_at", "category", ["created_at"], unique=False)
    op.create_index("ix_category_deleted_at", "category", ["deleted_at"], unique=False)
    op.create_index("ix_category_updated_at", "category", ["updated_at"], unique=False)
    op.create_table(
        "label",
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=False),
        ...
        sa.Column(
            "name", sa.String(length=191, collation="utf8mb4_bin"), nullable=False
        ),
    ...
    op.create_index("ix_label_created_at", "label", ["created_at"], unique=False)
    op.create_index("ix_label_deleted_at", "label", ["deleted_at"], unique=False)
    op.create_index("ix_label_updated_at", "label", ["updated_at"], unique=False)
    op.create_table(
        "messagecategory",
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=False),
    ...
    op.create_index(
        "ix_messagecategory_created_at", "messagecategory", ["created_at"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "imapuid_label_ids", "labelitem", ["imapuid_id", "label_id"], unique=False
    )
    op.create_index(
        "ix_labelitem_created_at", "labelitem", ["created_at"], unique=False
    )
    op.create_index(
        "ix_labelitem_deleted_at", "labelitem", ["deleted_at"], unique=False
    )
    op.create_index(
        "ix_labelitem_updated_at", "labelitem", ["updated_at"], unique=False
    )
    op.add_column("folder", sa.Column("category_id", sa.Integer(), nullable=True))
    ...
    if engine.has_table("easfoldersyncstatus"):
        op.add_column(
            "easfoldersyncstatus", sa.Column("category_id", sa.Integer(), nullable=True)
        )
        op.create_foreign_key(
