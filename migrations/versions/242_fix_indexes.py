...
def upgrade():
    op.create_index('ix_messagecontactassociation_contact_id', 'messagecontactassociation', ['contact_id'], unique=False)
    op.drop_index('ix_transaction_namespace_id', table_name='transaction')
    op.drop_index('idx_namespace', table_name='transaction')


def downgrade():
    op.drop_index('ix_messagecontactassociation_contact_id', table_name='messagecontactassociation')
    op.create_index('ix_transaction_namespace_id', 'transaction', ['namespace_id'], unique=False)
